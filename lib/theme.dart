...
final brightTheme = ThemeData(
  extensions: <ThemeExtension<dynamic>>[
    PollenMeterColors(
        lowRisk: const Color(0xffaaf683),
        moderateRisk: const Color(0xffffd97d),
        highRisk: const Color(0xffFF9B85),
        veryHighRisk: const Color(0xffEE6055),
        ...
        primaryDisplayLarge: theme.primaryTextTheme.displayLarge!.copyWith(
          fontSize: 18,
          fontWeight: FontWeight.normal,
          color: Colors.white,
          fontFamily: GoogleFonts.montserrat().fontFamily,
        ...
        primaryDisplayMedium: theme.primaryTextTheme.displayMedium!.copyWith(
            fontSize: 14,
            fontWeight: FontWeight.normal,
            color: Colors.black,
            fontFamily: GoogleFonts.montserrat().fontFamily,
            letterSpacing: 0),
        statsTitle: theme.textTheme.labelMedium!.copyWith(
          fontSize: 16,
          fontWeight: FontWeight.normal,
          color: Colors.black,
          fontFamily: GoogleFonts.montserrat().fontFamily,
...
final darkTheme = ThemeData(
  ...
  //firebase auth ui things
  brightness: Brightness.dark,
  canvasColor: const Color(0xff111412),
